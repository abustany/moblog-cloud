...
RUN adduser -h /home/adminserver -D adminserver
WORKDIR /home/adminserver
COPY --from=build /go/src/github.com/abustany/moblog-cloud/adminserver .
USER adminserver
CMD ["/home/adminserver/adminserver"]
